...
generateRdFile <- function(input_file) {
  ...
  len8_matrix  <- if(len8>0) matrix(data[65:(64+(5*len8))], ncol = 5, byrow = TRUE) else matrix(raw(0), ncol = 5)
  len16_matrix <- if(len16>0) matrix(data[(65+(5*len8)):(64+(5*len8)+(6*len16))], ncol = 6, byrow = TRUE) else matrix(raw(0), ncol = 6)
  len64_matrix <- if(len64>0) matrix(data[(65+(5*len8)+(6*len16)):(64+(5*len8)+(6*len16)+(12*len64))], ncol = 12, byrow = TRUE) else matrix(raw(0), ncol = 12)
